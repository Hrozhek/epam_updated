...
import static hometask20.common.solutions.comparator.SimpleComparator.LONG_COMPARATOR;
import static hometask20.common.solutions.comparator.SimpleComparator.STRING_COMPARATOR;
...
public class SerializationTest {
    ...
    public void createTempFile() throws IOException {
        tempFile = File.createTempFile("hometask20", ".txt");
    }
    ...
    private FoodCargo prepareFood() {
        ...
        food.setExpirationDate(LocalDateTime.now());
