...
import hometask20.cargo.repo.CargoRepo;
...
public class CargoServiceImpl implements CargoService {
        ...
        if (id != null) {
            if (transportationService != null) {
               ...
               /* for (Transportation transportation : transportations) {
                ...
                transportations.forEach((transportation) -> { if (transportation.getCargo().equals(cargo)) {
                        throw new CargoInUseDeleteException("Cargo " + cargo.getName() + ", id " + id +
                                " cannot be deleted due to it is in use in transportation id " + transportation.getId());
                    } });
    ...
    private static final Comparator<Cargo> CARGO_NAME_COMPARATOR = (o1, o2) -> o1.getName().compareTo(o2.getName());

    private static final Comparator<Cargo> CARGO_WEIGHT_COMPARATOR = (o1, o2) -> Double.compare(o1.getWeight(), o2.getWeight());
}
