package hometask15.storage.initor.fileinitor.sax;
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        switch (qName) {
            ...
            case "expirationDate": {
                ...
                cargo.setExpirationDate(new Date(Long.parseLong(data)));
                curCargo = cargo;
                break;
            }
            ...
            case "beginDate": {
                transportation.setTransportationBeginDate(new Date(Long.parseLong(data)));
            }
            case "Cargo": {
