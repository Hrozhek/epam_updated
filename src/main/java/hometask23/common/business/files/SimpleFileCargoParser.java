    ...
    public static void parse(String fileLine, Map<String, Cargo> cargoMap) {
        ...
        if (cargoType.equals("FOOD")) {
            ...
            if (!fourthParam.isEmpty()) {
                temp.setExpirationDate(LocalDateTime.parse(fourthParam, getDateFormatter()));
            }
