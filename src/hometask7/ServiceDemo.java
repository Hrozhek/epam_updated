...
public class ServiceDemo {
    public static void main(String[] args) {
        CargoService cargoServ = new CargoServiceImpl();
        CarrierService carrierServ = new CarrierServiceImpl();
        TransportationService transportationServ = new TransportationServiceImpl();
